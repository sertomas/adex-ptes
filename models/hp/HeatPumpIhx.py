...
from tespy.components import (Compressor, CycleCloser, HeatExchanger, Sink, Source, Valve)
...
class HeatPumpIhx(HeatPump):
    ...
    def generate_connections(self):
        ...
        self.conns['c33'] = Connection(self.comps['ihx'], 'out1', self.comps['val'], 'in1', label="33")
        self.conns['c34'] = Connection(self.comps['val'], 'out1', self.comps['eva'], 'in2', label="34")
