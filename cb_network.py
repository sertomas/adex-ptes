...
# "hp_expander" create a simple heat pump with expander instead of valve using the given working fluids
...
def hp_expander(working_fluids):
    ...
    c2 = Connection(evaporator_hp, 'out2', compressor, 'in1', label='2')
    c3 = Connection(compressor, 'out1', condenser_hp, 'in1', label='3')
    c4 = Connection(condenser_hp, 'out1', expander, 'in1', label='4')
    c0 = Connection(expander, 'out1', cycle_closer, 'in1', label='0')
